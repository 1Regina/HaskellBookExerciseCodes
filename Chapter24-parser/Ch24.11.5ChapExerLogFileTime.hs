-- credit: https://github.com/scarvalhojr/haskellbook/blob/master/chapter24/section24.11-5.hs
...
instance Show DailyLog where
  show (DailyLog date activities) = unlines $ ("# " ++ show date) :  -- unlines create a string from array of string with \ as divider
                                              (map show activities)
